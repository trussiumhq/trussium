...
required_modules = {
    ...
    "trussium/tools/__init__.py",
    "trussium/tools/contracts.py",
    "trussium/tools/execution.py",
    "trussium/tools/registry.py",
    "trussium/providers/openai/batches.py",
