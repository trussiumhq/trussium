...
the first major OSS release.

The release does not add new provider requirements. SDKs and provider adapters
remain independently versioned, and the Agent Runtime remains deferred.
