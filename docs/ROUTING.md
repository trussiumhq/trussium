...
breaking now temporarily excludes providers after repeated transient failures,
and re-allows them after the configured reset interval. Model fallback remains a
separate Milestone 7 feature. A capability
